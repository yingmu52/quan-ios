...
- (void)viewDidLoad {
    ...
    BFRImageContainerViewController *icvc = [self.imageViewControllers objectAtIndex:self.initialIndex];
    icvc.pageIndex = self.initialIndex;
    [self.pagerVC setViewControllers:@[icvc]
